...
<head>
    ...
    <link rel="icon" href="Imagenes/LogoMonster.png" type="image/x-icon">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        echo "<p>Gracias por contactar a Monster Gym Fitness Center. Hemos recibido tu mensaje y te responderemos pronto a tu correo $email. ¡Prepárate para entrenar como monstruo!</p>";
        echo "<a href='index.html'>Volver al formulario</a>"; // Cambiado a index.html
        echo "</div></body></html>";
    } catch (Exception $e) {
        ...
        echo "<a href='index.html'>Volver a intentarlo</a>"; // Cambiado a index.html
        echo "</div></body></html>";
    }
} else {
